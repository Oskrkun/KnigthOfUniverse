...
class WinGame(GameState):
    ...
    def init(self):
        ...
        self.mTextGameOver = TextSprite("WINNER", 40, "assets/fonts/ROBO.ttf", (0xFF, 0x00, 0x00))
        ...
        self.mTextExit.setXY(GameConstants.inst().SCREEN_WIDTH / 2 - self.mTextExit.getWidth(), 550)
        ...
        self.pocision = (GameConstants.inst().SCREEN_WIDTH / 2 - self.mTextExit.getWidth() + 120, 520)
    ...
    def update(self):
        ...
        if Keyboard.inst().fire():
            if self.pocision == (GameConstants.inst().SCREEN_WIDTH / 2 - self.mTextExit.getWidth() + 120, 520):
